...
latex_documents = [
    (master_doc, 'kinnetmt.tex', 'kinnetmt Documentation',
     'UIBCDF', 'manual'),
]
...
man_pages = [
    (master_doc, 'kinnetmt', 'kinnetmt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kinnetmt', 'kinnetmt Documentation',
     author, 'kinnetmt', 'One line description of project.',
     'Miscellaneous'),
]
